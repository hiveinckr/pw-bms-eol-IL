...
namespace _PeopleWorks__JF2_PBMS_EOL_Tester_IL
{
	internal class theApp
	{
		...
		public static CycloneEth _Cyclone = new CycloneEth();
		public static CycloneEth _Cyclone2 = new CycloneEth();

		 public static BarcodePrint _BarcodePrint = new BarcodePrint();
		 public static BarcodePrint _BarcodePrint2 = new BarcodePrint();


		public static MainWindow2 _window2;
		...
		public static CYCLON_STATUS _CyStatus2 = new CYCLON_STATUS();
			...
			switch (nProcessStep[nStepIndex])
			{
				...
				case 0:
					if (_BcdReader.bReadOk)
					{
						...
						{
							theApp.AppendLogMsg("Barcode format does not match.", MSG_TYPE.ERROR);
							_SysInfo.nTL_Beep = 3;
						}
				...
				case 51005:
					...
					if(_SysInfo._FileNameResult != CyclonFileName_RESULT.READY)
					{
						...
						{
							TestResultSet(_SysInfo.nMainWorkStep, _SysInfo.nCyclonFileName, "NG");
				...
				case 51010:
					...
					if(_CyStatus != CYCLON_STATUS.READY)
					{
						...
						{
							TestResultSet(_SysInfo.nMainWorkStep, _SysInfo.nCyclonFileName, "OK");
				...
				case 52005:
					if (_BcdReader.bReadOk)
					{
						...
						if (CheckBarcode(_ModelInfo.strBarcodSymbol, _BcdReader.strReadBarcode))
						{
				...
				case 52015:
					if (_BcdReader.bReadOk)
					{
						...
						if (CheckBarcode(_ModelInfo.strFuseBarcodSymbol, _BcdReader.strReadBarcode))
						{
				...
				case 52025:
					if (_BcdReader.bReadOk)
					{
						...
						if (CheckBarcode(_ModelInfo.strCaseBarcodSymbol, _BcdReader.strReadBarcode))
						{
				...
				case 52030:
					...
					theApp._BarcodePrint.strModelInfo = theApp._ModelInfo.strComment1 + theApp._ModelInfo.strComment2;
					theApp._BarcodePrint.strPrintBCD = theApp._LotCount.tProductClearTime.ToString("yyMMdd") /*+ theApp._ModelInfo.strBCDSymbol*/ + (theApp._LotCount.nLotCount /*+ theApp._ModelInfo.nStartLotNum*/).ToString("D4") + "Z";
		...
		public static void PROC_MAIN2()
		{
			...
			switch (nProcessStep[nStepIndex])
			{
				...
				case 21200:
					...
					int.TryParse(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue1.ToString(), out _SysInfo2.nCanAddr);
					//int.TryParse(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue2.ToString(), System.Globalization.NumberStyles.HexNumber, System.Globalization.CultureInfo.InvariantCulture, out _SysInfo2.nCanData);
					_SysInfo2.nCanData = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue2.ToString());
				...
				case 21500:
					...
					if (_SysInfo2.nCanMultiCount > 0) { _SysInfo2.nMultiSendData[0] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue3.ToString()); }
					if (_SysInfo2.nCanMultiCount > 1) { _SysInfo2.nMultiSendData[1] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue4.ToString()); }
					if (_SysInfo2.nCanMultiCount > 2) { _SysInfo2.nMultiSendData[2] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue5.ToString()); }
					if (_SysInfo2.nCanMultiCount > 3) { _SysInfo2.nMultiSendData[3] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue6.ToString()); }
					if (_SysInfo2.nCanMultiCount > 4) { _SysInfo2.nMultiSendData[4] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue7.ToString()); }
					if (_SysInfo2.nCanMultiCount > 5) { _SysInfo2.nMultiSendData[5] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue8.ToString()); }
					if (_SysInfo2.nCanMultiCount > 6) { _SysInfo2.nMultiSendData[6] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue9.ToString()); }
					if (_SysInfo2.nCanMultiCount > 7) { _SysInfo2.nMultiSendData[7] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue10.ToString()); }
					if (_SysInfo2.nCanMultiCount > 8) { _SysInfo2.nMultiSendData[8] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue11.ToString()); }
					if (_SysInfo2.nCanMultiCount > 9) { _SysInfo2.nMultiSendData[9] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue12.ToString()); }
					if (_SysInfo2.nCanMultiCount > 10) { _SysInfo2.nMultiSendData[10] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue13.ToString()); }
					if (_SysInfo2.nCanMultiCount > 11) { _SysInfo2.nMultiSendData[11] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue14.ToString()); }
					if (_SysInfo2.nCanMultiCount > 12) { _SysInfo2.nMultiSendData[12] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue15.ToString()); }
					if (_SysInfo2.nCanMultiCount > 13) { _SysInfo2.nMultiSendData[13] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue16.ToString()); }
					if (_SysInfo2.nCanMultiCount > 14) { _SysInfo2.nMultiSendData[14] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue17.ToString()); }
					if (_SysInfo2.nCanMultiCount > 15) { _SysInfo2.nMultiSendData[15] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue18.ToString()); }
					if (_SysInfo2.nCanMultiCount > 16) { _SysInfo2.nMultiSendData[16] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue19.ToString()); }
					if (_SysInfo2.nCanMultiCount > 17) { _SysInfo2.nMultiSendData[17] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue20.ToString()); }
					if (_SysInfo2.nCanMultiCount > 18) { _SysInfo2.nMultiSendData[18] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue21.ToString()); }
					if (_SysInfo2.nCanMultiCount > 19) { _SysInfo2.nMultiSendData[19] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue22.ToString()); }
					if (_SysInfo2.nCanMultiCount > 20) { _SysInfo2.nMultiSendData[20] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue23.ToString()); }
					if (_SysInfo2.nCanMultiCount > 21) { _SysInfo2.nMultiSendData[21] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue24.ToString()); }
					if (_SysInfo2.nCanMultiCount > 22) { _SysInfo2.nMultiSendData[22] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue25.ToString()); }
					if (_SysInfo2.nCanMultiCount > 23) { _SysInfo2.nMultiSendData[23] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue26.ToString()); }
					if (_SysInfo2.nCanMultiCount > 24) { _SysInfo2.nMultiSendData[24] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue27.ToString()); }
					if (_SysInfo2.nCanMultiCount > 25) { _SysInfo2.nMultiSendData[25] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue28.ToString()); }
					if (_SysInfo2.nCanMultiCount > 26) { _SysInfo2.nMultiSendData[26] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue29.ToString()); }
					if (_SysInfo2.nCanMultiCount > 27) { _SysInfo2.nMultiSendData[27] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue30.ToString()); }
					if (_SysInfo2.nCanMultiCount > 28) { _SysInfo2.nMultiSendData[28] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue31.ToString()); }
					if (_SysInfo2.nCanMultiCount > 29) { _SysInfo2.nMultiSendData[29] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue32.ToString()); }
					if (_SysInfo2.nCanMultiCount > 30) { _SysInfo2.nMultiSendData[30] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue33.ToString()); }
					if (_SysInfo2.nCanMultiCount > 31) { _SysInfo2.nMultiSendData[31] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue34.ToString()); }
					if (_SysInfo2.nCanMultiCount > 32) { _SysInfo2.nMultiSendData[32] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue35.ToString()); }
					if (_SysInfo2.nCanMultiCount > 33) { _SysInfo2.nMultiSendData[33] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue36.ToString()); }
					if (_SysInfo2.nCanMultiCount > 34) { _SysInfo2.nMultiSendData[34] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue37.ToString()); }
					if (_SysInfo2.nCanMultiCount > 35) { _SysInfo2.nMultiSendData[35] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue38.ToString()); }
					if (_SysInfo2.nCanMultiCount > 36) { _SysInfo2.nMultiSendData[36] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue39.ToString()); }
					if (_SysInfo2.nCanMultiCount > 37) { _SysInfo2.nMultiSendData[37] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue40.ToString()); }
					if (_SysInfo2.nCanMultiCount > 38) { _SysInfo2.nMultiSendData[38] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue41.ToString()); }
					if (_SysInfo2.nCanMultiCount > 39) { _SysInfo2.nMultiSendData[39] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue42.ToString()); }
					if (_SysInfo2.nCanMultiCount > 40) { _SysInfo2.nMultiSendData[40] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue43.ToString()); }
					if (_SysInfo2.nCanMultiCount > 41) { _SysInfo2.nMultiSendData[41] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue44.ToString()); }
					if (_SysInfo2.nCanMultiCount > 42) { _SysInfo2.nMultiSendData[42] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue45.ToString()); }
					if (_SysInfo2.nCanMultiCount > 43) { _SysInfo2.nMultiSendData[43] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue46.ToString()); }
					if (_SysInfo2.nCanMultiCount > 44) { _SysInfo2.nMultiSendData[44] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue47.ToString()); }
					if (_SysInfo2.nCanMultiCount > 45) { _SysInfo2.nMultiSendData[45] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue48.ToString()); }
					if (_SysInfo2.nCanMultiCount > 46) { _SysInfo2.nMultiSendData[46] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue49.ToString()); }
					if (_SysInfo2.nCanMultiCount > 47) { _SysInfo2.nMultiSendData[47] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue50.ToString()); }
					if (_SysInfo2.nCanMultiCount > 48) { _SysInfo2.nMultiSendData[48] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue51.ToString()); }
					if (_SysInfo2.nCanMultiCount > 49) { _SysInfo2.nMultiSendData[49] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue52.ToString()); }
					if (_SysInfo2.nCanMultiCount > 50) { _SysInfo2.nMultiSendData[50] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue53.ToString()); }
					if (_SysInfo2.nCanMultiCount > 51) { _SysInfo2.nMultiSendData[51] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue54.ToString()); }
					if (_SysInfo2.nCanMultiCount > 52) { _SysInfo2.nMultiSendData[52] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue55.ToString()); }
					if (_SysInfo2.nCanMultiCount > 53) { _SysInfo2.nMultiSendData[53] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue56.ToString()); }
					if (_SysInfo2.nCanMultiCount > 54) { _SysInfo2.nMultiSendData[54] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue57.ToString()); }
					if (_SysInfo2.nCanMultiCount > 55) { _SysInfo2.nMultiSendData[55] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue58.ToString()); }
					if (_SysInfo2.nCanMultiCount > 56) { _SysInfo2.nMultiSendData[56] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue59.ToString()); }
					if (_SysInfo2.nCanMultiCount > 57) { _SysInfo2.nMultiSendData[57] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue60.ToString()); }
					if (_SysInfo2.nCanMultiCount > 58) { _SysInfo2.nMultiSendData[58] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue61.ToString()); }
					if (_SysInfo2.nCanMultiCount > 59) { _SysInfo2.nMultiSendData[59] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue62.ToString()); }
					if (_SysInfo2.nCanMultiCount > 60) { _SysInfo2.nMultiSendData[60] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue63.ToString()); }
					if (_SysInfo2.nCanMultiCount > 61) { _SysInfo2.nMultiSendData[61] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue64.ToString()); }
					if (_SysInfo2.nCanMultiCount > 62) { _SysInfo2.nMultiSendData[62] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue65.ToString()); }
					if (_SysInfo2.nCanMultiCount > 63) { _SysInfo2.nMultiSendData[63] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue66.ToString()); }
					if (_SysInfo2.nCanMultiCount > 64) { _SysInfo2.nMultiSendData[64] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue67.ToString()); }
					if (_SysInfo2.nCanMultiCount > 65) { _SysInfo2.nMultiSendData[65] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue68.ToString()); }
					if (_SysInfo2.nCanMultiCount > 66) { _SysInfo2.nMultiSendData[66] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue69.ToString()); }
					if (_SysInfo2.nCanMultiCount > 67) { _SysInfo2.nMultiSendData[67] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue70.ToString()); }
					if (_SysInfo2.nCanMultiCount > 68) { _SysInfo2.nMultiSendData[68] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue71.ToString()); }
					if (_SysInfo2.nCanMultiCount > 69) { _SysInfo2.nMultiSendData[69] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue72.ToString()); }
					if (_SysInfo2.nCanMultiCount > 70) { _SysInfo2.nMultiSendData[70] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue73.ToString()); }
					if (_SysInfo2.nCanMultiCount > 71) { _SysInfo2.nMultiSendData[71] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue74.ToString()); }
					if (_SysInfo2.nCanMultiCount > 72) { _SysInfo2.nMultiSendData[72] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue75.ToString()); }
					if (_SysInfo2.nCanMultiCount > 73) { _SysInfo2.nMultiSendData[73] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue76.ToString()); }
					if (_SysInfo2.nCanMultiCount > 74) { _SysInfo2.nMultiSendData[74] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue77.ToString()); }
					if (_SysInfo2.nCanMultiCount > 75) { _SysInfo2.nMultiSendData[75] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue78.ToString()); }
					if (_SysInfo2.nCanMultiCount > 76) { _SysInfo2.nMultiSendData[76] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue79.ToString()); }
					if (_SysInfo2.nCanMultiCount > 77) { _SysInfo2.nMultiSendData[77] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue80.ToString()); }
					if (_SysInfo2.nCanMultiCount > 78) { _SysInfo2.nMultiSendData[78] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue81.ToString()); }
					if (_SysInfo2.nCanMultiCount > 79) { _SysInfo2.nMultiSendData[79] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue82.ToString()); }
					if (_SysInfo2.nCanMultiCount > 80) { _SysInfo2.nMultiSendData[80] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue83.ToString()); }
					if (_SysInfo2.nCanMultiCount > 81) { _SysInfo2.nMultiSendData[81] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue84.ToString()); }
					if (_SysInfo2.nCanMultiCount > 82) { _SysInfo2.nMultiSendData[82] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue85.ToString()); }
					if (_SysInfo2.nCanMultiCount > 83) { _SysInfo2.nMultiSendData[83] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue86.ToString()); }
					if (_SysInfo2.nCanMultiCount > 84) { _SysInfo2.nMultiSendData[84] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue87.ToString()); }
					if (_SysInfo2.nCanMultiCount > 85) { _SysInfo2.nMultiSendData[85] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue88.ToString()); }
					if (_SysInfo2.nCanMultiCount > 86) { _SysInfo2.nMultiSendData[86] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue89.ToString()); }
					if (_SysInfo2.nCanMultiCount > 87) { _SysInfo2.nMultiSendData[87] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue90.ToString()); }
					if (_SysInfo2.nCanMultiCount > 88) { _SysInfo2.nMultiSendData[88] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue91.ToString()); }
					if (_SysInfo2.nCanMultiCount > 89) { _SysInfo2.nMultiSendData[89] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue92.ToString()); }
					if (_SysInfo2.nCanMultiCount > 90) { _SysInfo2.nMultiSendData[90] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue93.ToString()); }
					if (_SysInfo2.nCanMultiCount > 91) { _SysInfo2.nMultiSendData[91] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue94.ToString()); }
					if (_SysInfo2.nCanMultiCount > 92) { _SysInfo2.nMultiSendData[92] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue95.ToString()); }
					if (_SysInfo2.nCanMultiCount > 93) { _SysInfo2.nMultiSendData[93] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue96.ToString()); }
					if (_SysInfo2.nCanMultiCount > 94) { _SysInfo2.nMultiSendData[94] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue97.ToString()); }
					if (_SysInfo2.nCanMultiCount > 95) { _SysInfo2.nMultiSendData[95] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue98.ToString()); }
					if (_SysInfo2.nCanMultiCount > 96) { _SysInfo2.nMultiSendData[96] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue99.ToString()); }
					if (_SysInfo2.nCanMultiCount > 97) { _SysInfo2.nMultiSendData[97] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue100.ToString()); }
				...
				case 21800:
					...
					SendTCPMultiCommand(_SysInfo2.nCanCh, _SysInfo2.nCanAddr, _SysInfo2.nMultiSendData, _SysInfo2.nCanMultiCount);
					nProcessStep[nStepIndex]++;
					break;
				...
				case 51000:
					_SysInfo2._FileNameResult = CyclonFileName_RESULT.READY;
					_CyStatus2 = CYCLON_STATUS.READY;
				...
				case 51005:
					...
					if (_SysInfo2._FileNameResult != CyclonFileName_RESULT.READY)
					{
						if (_SysInfo2._FileNameResult == CyclonFileName_RESULT.OK)
						{
							nProcessStep[nStepIndex] = 51009;
						}
						else
						{
							TestResultSet2(_SysInfo2.nMainWorkStep, _SysInfo2.nCyclonFileName, "NG");
							_SysInfo2.nMainWorkStep++;
							nProcessStep[nStepIndex] = 3000;
							break;
						}
				...
				case 51010:
					...
					if(_CyStatus2 != CYCLON_STATUS.READY)
					{
						if (_CyStatus2 == CYCLON_STATUS.OK)
						{
							TestResultSet2(_SysInfo2.nMainWorkStep, _SysInfo2.nCyclonFileName, "OK");
				...
				case 52005:
					if(_BcdReader2.bReadOk)
					{
						...
						if (CheckBarcode(_ModelInfo2.strBarcodSymbol, _BcdReader2.strReadBarcode))
						{
				...
				case 52015:
					if (_BcdReader2.bReadOk)
					{
						...
						if (CheckBarcode(_ModelInfo2.strFuseBarcodSymbol, _BcdReader2.strReadBarcode))
						{
				...
				case 52025:
					if (_BcdReader2.bReadOk)
					{
						...
						if (CheckBarcode(_ModelInfo2.strCaseBarcodSymbol, _BcdReader2.strReadBarcode))
						{
				...
				case 52030:
					...
					theApp._BarcodePrint2.strModelInfo = theApp._ModelInfo2.strComment1 + theApp._ModelInfo2.strComment2;
					theApp._BarcodePrint2.strPrintBCD = theApp._LotCount2.tProductClearTime.ToString("yyMMdd")/* + theApp._ModelInfo2.strBCDSymbol*/ + (theApp._LotCount2.nLotCount /*+ theApp._ModelInfo.nStartLotNum*/).ToString("D4") +"Z";
		...
		public static void SUB_EOL2()
		{
			...
			switch (nProcessStep[nStepIndex])
			{
				...
				case 21200:
					...
					int.TryParse(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue1.ToString(), out _SysInfo2.nCanAddr);
					//int.TryParse(_ModelInfo2._TestInfo[_SysInfo2.nMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue2.ToString(), System.Globalization.NumberStyles.HexNumber, System.Globalization.CultureInfo.InvariantCulture, out _SysInfo2.nCanData);
					_SysInfo2.nCanData = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue2.ToString());
					SendReadCommand(_SysInfo2.nCanCh, _SysInfo2.nCanAddr, 2);
				...
				case 21500:
					...
					if (_SysInfo2.nCanMultiCount > 0) { _SysInfo2.nMultiSendData[0] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue3.ToString()); }
					if (_SysInfo2.nCanMultiCount > 1) { _SysInfo2.nMultiSendData[1] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue4.ToString()); }
					if (_SysInfo2.nCanMultiCount > 2) { _SysInfo2.nMultiSendData[2] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue5.ToString()); }
					if (_SysInfo2.nCanMultiCount > 3) { _SysInfo2.nMultiSendData[3] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue6.ToString()); }
					if (_SysInfo2.nCanMultiCount > 4) { _SysInfo2.nMultiSendData[4] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue7.ToString()); }
					if (_SysInfo2.nCanMultiCount > 5) { _SysInfo2.nMultiSendData[5] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue8.ToString()); }
					if (_SysInfo2.nCanMultiCount > 6) { _SysInfo2.nMultiSendData[6] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue9.ToString()); }
					if (_SysInfo2.nCanMultiCount > 7) { _SysInfo2.nMultiSendData[7] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue10.ToString()); }
					if (_SysInfo2.nCanMultiCount > 8) { _SysInfo2.nMultiSendData[8] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue11.ToString()); }
					if (_SysInfo2.nCanMultiCount > 9) { _SysInfo2.nMultiSendData[9] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue12.ToString()); }
					if (_SysInfo2.nCanMultiCount > 10) { _SysInfo2.nMultiSendData[10] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue13.ToString()); }
					if (_SysInfo2.nCanMultiCount > 11) { _SysInfo2.nMultiSendData[11] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue14.ToString()); }
					if (_SysInfo2.nCanMultiCount > 12) { _SysInfo2.nMultiSendData[12] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue15.ToString()); }
					if (_SysInfo2.nCanMultiCount > 13) { _SysInfo2.nMultiSendData[13] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue16.ToString()); }
					if (_SysInfo2.nCanMultiCount > 14) { _SysInfo2.nMultiSendData[14] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue17.ToString()); }
					if (_SysInfo2.nCanMultiCount > 15) { _SysInfo2.nMultiSendData[15] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue18.ToString()); }
					if (_SysInfo2.nCanMultiCount > 16) { _SysInfo2.nMultiSendData[16] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue19.ToString()); }
					if (_SysInfo2.nCanMultiCount > 17) { _SysInfo2.nMultiSendData[17] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue20.ToString()); }
					if (_SysInfo2.nCanMultiCount > 18) { _SysInfo2.nMultiSendData[18] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue21.ToString()); }
					if (_SysInfo2.nCanMultiCount > 19) { _SysInfo2.nMultiSendData[19] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue22.ToString()); }
					if (_SysInfo2.nCanMultiCount > 20) { _SysInfo2.nMultiSendData[20] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue23.ToString()); }
					if (_SysInfo2.nCanMultiCount > 21) { _SysInfo2.nMultiSendData[21] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue24.ToString()); }
					if (_SysInfo2.nCanMultiCount > 22) { _SysInfo2.nMultiSendData[22] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue25.ToString()); }
					if (_SysInfo2.nCanMultiCount > 23) { _SysInfo2.nMultiSendData[23] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue26.ToString()); }
					if (_SysInfo2.nCanMultiCount > 24) { _SysInfo2.nMultiSendData[24] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue27.ToString()); }
					if (_SysInfo2.nCanMultiCount > 25) { _SysInfo2.nMultiSendData[25] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue28.ToString()); }
					if (_SysInfo2.nCanMultiCount > 26) { _SysInfo2.nMultiSendData[26] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue29.ToString()); }
					if (_SysInfo2.nCanMultiCount > 27) { _SysInfo2.nMultiSendData[27] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue30.ToString()); }
					if (_SysInfo2.nCanMultiCount > 28) { _SysInfo2.nMultiSendData[28] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue31.ToString()); }
					if (_SysInfo2.nCanMultiCount > 29) { _SysInfo2.nMultiSendData[29] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue32.ToString()); }
					if (_SysInfo2.nCanMultiCount > 30) { _SysInfo2.nMultiSendData[30] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue33.ToString()); }
					if (_SysInfo2.nCanMultiCount > 31) { _SysInfo2.nMultiSendData[31] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue34.ToString()); }
					if (_SysInfo2.nCanMultiCount > 32) { _SysInfo2.nMultiSendData[32] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue35.ToString()); }
					if (_SysInfo2.nCanMultiCount > 33) { _SysInfo2.nMultiSendData[33] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue36.ToString()); }
					if (_SysInfo2.nCanMultiCount > 34) { _SysInfo2.nMultiSendData[34] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue37.ToString()); }
					if (_SysInfo2.nCanMultiCount > 35) { _SysInfo2.nMultiSendData[35] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue38.ToString()); }
					if (_SysInfo2.nCanMultiCount > 36) { _SysInfo2.nMultiSendData[36] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue39.ToString()); }
					if (_SysInfo2.nCanMultiCount > 37) { _SysInfo2.nMultiSendData[37] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue40.ToString()); }
					if (_SysInfo2.nCanMultiCount > 38) { _SysInfo2.nMultiSendData[38] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue41.ToString()); }
					if (_SysInfo2.nCanMultiCount > 39) { _SysInfo2.nMultiSendData[39] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue42.ToString()); }
					if (_SysInfo2.nCanMultiCount > 40) { _SysInfo2.nMultiSendData[40] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue43.ToString()); }
					if (_SysInfo2.nCanMultiCount > 41) { _SysInfo2.nMultiSendData[41] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue44.ToString()); }
					if (_SysInfo2.nCanMultiCount > 42) { _SysInfo2.nMultiSendData[42] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue45.ToString()); }
					if (_SysInfo2.nCanMultiCount > 43) { _SysInfo2.nMultiSendData[43] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue46.ToString()); }
					if (_SysInfo2.nCanMultiCount > 44) { _SysInfo2.nMultiSendData[44] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue47.ToString()); }
					if (_SysInfo2.nCanMultiCount > 45) { _SysInfo2.nMultiSendData[45] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue48.ToString()); }
					if (_SysInfo2.nCanMultiCount > 46) { _SysInfo2.nMultiSendData[46] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue49.ToString()); }
					if (_SysInfo2.nCanMultiCount > 47) { _SysInfo2.nMultiSendData[47] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue50.ToString()); }
					if (_SysInfo2.nCanMultiCount > 48) { _SysInfo2.nMultiSendData[48] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue51.ToString()); }
					if (_SysInfo2.nCanMultiCount > 49) { _SysInfo2.nMultiSendData[49] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue52.ToString()); }
					if (_SysInfo2.nCanMultiCount > 50) { _SysInfo2.nMultiSendData[50] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue53.ToString()); }
					if (_SysInfo2.nCanMultiCount > 51) { _SysInfo2.nMultiSendData[51] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue54.ToString()); }
					if (_SysInfo2.nCanMultiCount > 52) { _SysInfo2.nMultiSendData[52] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue55.ToString()); }
					if (_SysInfo2.nCanMultiCount > 53) { _SysInfo2.nMultiSendData[53] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue56.ToString()); }
					if (_SysInfo2.nCanMultiCount > 54) { _SysInfo2.nMultiSendData[54] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue57.ToString()); }
					if (_SysInfo2.nCanMultiCount > 55) { _SysInfo2.nMultiSendData[55] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue58.ToString()); }
					if (_SysInfo2.nCanMultiCount > 56) { _SysInfo2.nMultiSendData[56] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue59.ToString()); }
					if (_SysInfo2.nCanMultiCount > 57) { _SysInfo2.nMultiSendData[57] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue60.ToString()); }
					if (_SysInfo2.nCanMultiCount > 58) { _SysInfo2.nMultiSendData[58] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue61.ToString()); }
					if (_SysInfo2.nCanMultiCount > 59) { _SysInfo2.nMultiSendData[59] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue62.ToString()); }
					if (_SysInfo2.nCanMultiCount > 60) { _SysInfo2.nMultiSendData[60] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue63.ToString()); }
					if (_SysInfo2.nCanMultiCount > 61) { _SysInfo2.nMultiSendData[61] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue64.ToString()); }
					if (_SysInfo2.nCanMultiCount > 62) { _SysInfo2.nMultiSendData[62] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue65.ToString()); }
					if (_SysInfo2.nCanMultiCount > 63) { _SysInfo2.nMultiSendData[63] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue66.ToString()); }
					if (_SysInfo2.nCanMultiCount > 64) { _SysInfo2.nMultiSendData[64] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue67.ToString()); }
					if (_SysInfo2.nCanMultiCount > 65) { _SysInfo2.nMultiSendData[65] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue68.ToString()); }
					if (_SysInfo2.nCanMultiCount > 66) { _SysInfo2.nMultiSendData[66] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue69.ToString()); }
					if (_SysInfo2.nCanMultiCount > 67) { _SysInfo2.nMultiSendData[67] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue70.ToString()); }
					if (_SysInfo2.nCanMultiCount > 68) { _SysInfo2.nMultiSendData[68] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue71.ToString()); }
					if (_SysInfo2.nCanMultiCount > 69) { _SysInfo2.nMultiSendData[69] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue72.ToString()); }
					if (_SysInfo2.nCanMultiCount > 70) { _SysInfo2.nMultiSendData[70] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue73.ToString()); }
					if (_SysInfo2.nCanMultiCount > 71) { _SysInfo2.nMultiSendData[71] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue74.ToString()); }
					if (_SysInfo2.nCanMultiCount > 72) { _SysInfo2.nMultiSendData[72] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue75.ToString()); }
					if (_SysInfo2.nCanMultiCount > 73) { _SysInfo2.nMultiSendData[73] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue76.ToString()); }
					if (_SysInfo2.nCanMultiCount > 74) { _SysInfo2.nMultiSendData[74] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue77.ToString()); }
					if (_SysInfo2.nCanMultiCount > 75) { _SysInfo2.nMultiSendData[75] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue78.ToString()); }
					if (_SysInfo2.nCanMultiCount > 76) { _SysInfo2.nMultiSendData[76] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue79.ToString()); }
					if (_SysInfo2.nCanMultiCount > 77) { _SysInfo2.nMultiSendData[77] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue80.ToString()); }
					if (_SysInfo2.nCanMultiCount > 78) { _SysInfo2.nMultiSendData[78] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue81.ToString()); }
					if (_SysInfo2.nCanMultiCount > 79) { _SysInfo2.nMultiSendData[79] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue82.ToString()); }
					if (_SysInfo2.nCanMultiCount > 80) { _SysInfo2.nMultiSendData[80] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue83.ToString()); }
					if (_SysInfo2.nCanMultiCount > 81) { _SysInfo2.nMultiSendData[81] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue84.ToString()); }
					if (_SysInfo2.nCanMultiCount > 82) { _SysInfo2.nMultiSendData[82] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue85.ToString()); }
					if (_SysInfo2.nCanMultiCount > 83) { _SysInfo2.nMultiSendData[83] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue86.ToString()); }
					if (_SysInfo2.nCanMultiCount > 84) { _SysInfo2.nMultiSendData[84] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue87.ToString()); }
					if (_SysInfo2.nCanMultiCount > 85) { _SysInfo2.nMultiSendData[85] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue88.ToString()); }
					if (_SysInfo2.nCanMultiCount > 86) { _SysInfo2.nMultiSendData[86] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue89.ToString()); }
					if (_SysInfo2.nCanMultiCount > 87) { _SysInfo2.nMultiSendData[87] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue90.ToString()); }
					if (_SysInfo2.nCanMultiCount > 88) { _SysInfo2.nMultiSendData[88] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue91.ToString()); }
					if (_SysInfo2.nCanMultiCount > 89) { _SysInfo2.nMultiSendData[89] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue92.ToString()); }
					if (_SysInfo2.nCanMultiCount > 90) { _SysInfo2.nMultiSendData[90] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue93.ToString()); }
					if (_SysInfo2.nCanMultiCount > 91) { _SysInfo2.nMultiSendData[91] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue94.ToString()); }
					if (_SysInfo2.nCanMultiCount > 92) { _SysInfo2.nMultiSendData[92] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue95.ToString()); }
					if (_SysInfo2.nCanMultiCount > 93) { _SysInfo2.nMultiSendData[93] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue96.ToString()); }
					if (_SysInfo2.nCanMultiCount > 94) { _SysInfo2.nMultiSendData[94] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue97.ToString()); }
					if (_SysInfo2.nCanMultiCount > 95) { _SysInfo2.nMultiSendData[95] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue98.ToString()); }
					if (_SysInfo2.nCanMultiCount > 96) { _SysInfo2.nMultiSendData[96] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue99.ToString()); }
					if (_SysInfo2.nCanMultiCount > 97) { _SysInfo2.nMultiSendData[97] = GetFuncData(_ModelInfo2._TestInfo[_SysInfo2.nSubMainWorkStep]._DataInfo[_SysInfo2.nSubWorkStep].strValue100.ToString()); }
						...
						if (_ModelInfo2._TestInfo[i].nTestItem == 0)
						{
							...
							for (int j = 0; j < _ModelInfo2._TestInfo[i]._DataInfo.Count; j++)
							{
									...
									_ModelInfo2._TestInfo[i]._DataInfo[j].nTestType == 9)
								{
									...
									{
										_SysInfo2.nValue2Data = GetFuncData(_ModelInfo2._TestInfo[i]._DataInfo[j].strValue2.ToString());
		...
		public static void CyclonReadFirWareName(int FileInNum, string strSearchString)
		{
			...
			{
				_SysInfo.nCyclonFileName = cyclone_control_api.getImageDescription(handle, Convert.ToByte(FileInNum));
				
				//_SysInfo.bGetFileNameOK = true;
				theApp.AppendLogMsg($"{cyclone_control_api.getImageDescription(handle, Convert.ToByte(FileInNum))}", MSG_TYPE.INFO);

				
				if (_SysInfo.nCyclonFileName.Contains(strSearchString))
				{
		...
		public static void CyclonInFirWare2(int HandleNum)
		{
			...
			//connection_type = convert_dropboxindex_to_connectiontype(1);
			handle1 = cyclone_control_api.connectToCyclone(_Config.strCycloneMyIP2);
			if (handle1 == 0)
			{
				theApp.AppendLogMsg2($"Error Opening Device", MSG_TYPE.LOG);
				_CyStatus2 = CYCLON_STATUS.NG;
			...
			do
			{
				...
				if (cyclone_control_api.checkCycloneExecutionStatus(handle1) == 0)
				{
					if (cyclone_control_api.getNumberOfErrors(handle1) == 0)
					{
						...
						_CyStatus2 = CYCLON_STATUS.OK;
					}
					else
					{
						theApp.AppendLogMsg2($"Error Code = {cyclone_control_api.getErrorCode(handle1, 1).ToString()}", MSG_TYPE.LOG);
						_CyStatus2 = CYCLON_STATUS.NG;
					}
		...
		public static void CyclonReadFirWareName2(int FileInNum, string strSearchString)
		{
			...
			if (handle == 0)
			{
				theApp.AppendLogMsg2("Error Opening Device.", MSG_TYPE.LOG);
				//_SysInfo.bGetFileNameOK = true;
				_SysInfo2._FileNameResult = CyclonFileName_RESULT.NG;
			}
			else
			{
				_SysInfo2.nCyclonFileName = cyclone_control_api.getImageDescription(handle, Convert.ToByte(FileInNum));

				//_SysInfo.bGetFileNameOK = true;
				theApp.AppendLogMsg2($"{cyclone_control_api.getImageDescription(handle, Convert.ToByte(FileInNum))}", MSG_TYPE.INFO);


				if (_SysInfo2.nCyclonFileName.Contains(strSearchString))
				{
					_SysInfo2._FileNameResult = CyclonFileName_RESULT.OK;
				}
				else
				{
					_SysInfo2._FileNameResult = CyclonFileName_RESULT.NG;
		...
		public static void CanLogDataWrite(myCanData _Data)
		{
			App.Current.Dispatcher.InvokeAsync((Action)delegate // <--- HERE         // Log Clear
			{
				((MainWindow)App.Current.MainWindow).CanLogData(_Data);
			});
		}

		public static void CanLogDataWrite2(myCanData2 _Data)
		{
		
			App.Current.Dispatcher.InvokeAsync((Action)delegate // <--- HERE         // Log Clear
			{
				MainWindow2 _window2 = new MainWindow2();
				_window2.CanLogData2(_Data);
		...
		static void SaveBarcodeInfo()
		{
			...
			strDaySave += _SysInfo.strPBMSBcd + ",";
			strDaySave += _SysInfo.strFuseBcd + ",";
			strDaySave += _SysInfo.strCaseBcd + ",";
			...
			try
			{
				//===============우리쪽 임시데이터 저장 =========
				// 바코드 파일
				string strSaveFolderPath = String.Format(@"DATA\\BCD\\{0}\\{1}\\", theApp._ModelInfo.strModelName, theApp._LotCount.tLotClearTime.ToString("yyMMdd"));
				DirectoryInfo Savedir = new DirectoryInfo(strSaveFolderPath);
				if (Savedir.Exists == false) { Savedir.Create(); }
				...
				strSaveFilePath = String.Format(@"{0}{1}{2}.txt", strSaveFolderPath, theApp._LotCount.tLotClearTime.ToString("yyMMdd"), strOutputBCD);
				File.WriteAllText(strSaveFilePath, strPrintBcd);
				...
				//========================== BackUp 데이터 저장
				strSaveFolderPath = String.Format(@"BACKUP\\BCD\\{0}\\{1}\\", theApp._ModelInfo.strModelName, theApp._LotCount.tLotClearTime.ToString("yyMMdd"));
				Savedir = new DirectoryInfo(strSaveFolderPath);
				if (Savedir.Exists == false) { Savedir.Create(); }
		...
		static void SaveBarcodeInfo2()
		{
			...
			strDaySave += _SysInfo2.strPBMSBcd + ",";
			strDaySave += _SysInfo2.strFuseBcd + ",";
			strDaySave += _SysInfo2.strCaseBcd + ",";
			...
			try
			{
				//===============우리쪽 임시데이터 저장 =========
				// 바코드 파일
				string strSaveFolderPath = String.Format(@"DATA2\\BCD\\{0}\\{1}\\", theApp._ModelInfo2.strModelName, theApp._LotCount2.tLotClearTime.ToString("yyMMdd"));
				DirectoryInfo Savedir = new DirectoryInfo(strSaveFolderPath);
				if (Savedir.Exists == false) { Savedir.Create(); }
				...
				strSaveFilePath = String.Format(@"{0}{1}{2}.txt", strSaveFolderPath, theApp._LotCount2.tLotClearTime.ToString("yyMMdd"), strOutputBCD);
				File.WriteAllText(strSaveFilePath, strPrintBcd);
				...
				//========================== BackUp 데이터 저장
				strSaveFolderPath = String.Format(@"BACKUP2\\BCD\\{0}\\{1}\\", theApp._ModelInfo2.strModelName, theApp._LotCount2.tLotClearTime.ToString("yyMMdd"));
				Savedir = new DirectoryInfo(strSaveFolderPath);
				if (Savedir.Exists == false) { Savedir.Create(); }
